...
1. **EZworkEra**
    ...
    * *EZworkEra*는 ver 4.0.0 현재 eraTW의 파일구조를 참고하여 만들어졌습니다. 따라서 타 era에서의 구동을 보장할 수 없습니다만, 범용적으로 사용 가능하게 만들기 위해 노력하고 있습니다.  
    * *EZworkEra*는 ver 4.0.0 현재 python 3.8.5를 기반으로 작성되고 있습니다.
...
3. ~~**krjp_simple_converter**~~
    ...
    * **21.02.26 현재 문제가 발생하고 있기에 사용을 지양해주세요.**
...
2. **구상 추출**  
  선택한 폴더 내의 모든 erb 내에서 `PRINT`, `DATAFORM`으로 된 모든 줄을 검색해 그 결과물을 ERB 파일별로 출력 가능한 `SheetInfo`형 자료로 저장합니다.
  v4.0.0 현재 선택 가능한 옵션은 다음과 같습니다.
